...
class WorldDescription:
    def __init__(
        ...
        ground_row_profile_width: float = 0.45,
        ground_row_ridge_height: float = 0.07,
        ground_row_lane_depth: float = 0.05,
    ...
    def unpack_param(
        self, rows: int, value: list[float | int] | float | int
    ) -> list[float | int]:
    ...
    def random_description(self) -> None:
        ...
        self.structure["params"] = {
            ...
            "ground_row_profile_width": self.ground_row_profile_width,
            "ground_row_ridge_height": self.ground_row_ridge_height,
            "ground_row_lane_depth": self.ground_row_lane_depth,
